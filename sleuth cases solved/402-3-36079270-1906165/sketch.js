...
Officer: tchow004
CaseNum: 402-3-36079270-1906165
...
function draw()
{
    ...
    if (det.locationY < 509 && det.locationX < 198)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    if (det.locationY < 382)
    {
        det.speedX = 1;
        det.speedY = 0;
    }
    if (det.locationY < 382 && det.locationX > 572)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    if (det.locationY < 263)
    {
        det.speedX = -1;
        det.speedY = 0;
    }
    if (det.locationY < 263 && det.locationX < 323)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    ...
    if (det.locationY < 140 && det.locationX > 823)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    ...
    if (det.locationY < 73 && det.locationX < 130)
    {
        det.speedX = 0;
        det.speedY = -1;
    }

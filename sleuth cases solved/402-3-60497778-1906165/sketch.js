...
Officer: tchow004
CaseNum: 402-3-60497778-1906165
...
function draw()
{
    ...
    if(det.locationX > 696)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if(det.locationY > 256)
    {
        det.speedX = -1;
        det.speedY = 0;
    }
    if(det.locationY > 256 && det.locationX < 261)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if(det.locationX > 820)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if(det.locationY >566)
    {
        det.speedX = -1;
        det.speedY = 0;
    }
   if(det.locationX < 451 && det.locationY > 566)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if(det.locationX > 758 && det.locationY > 632)
    {
        det.speedX = 0;
        det.speedY = 1;
    }

...
Officer: tchow004
CaseNum: 402-3-65660897-1906165
...
function draw()
{
    ...
    if (det.locationY < 386 && det.locationX > 572)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    ...
    if (det.locationY < 260 && det.locationX < 324)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    ...
    if (det.locationY < 135 && det.locationX > 823)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    ...
    if (det.locationY < 70 && det.locationX < 140)
    {
        det.speedX = 0;
        det.speedY = -1;
    }

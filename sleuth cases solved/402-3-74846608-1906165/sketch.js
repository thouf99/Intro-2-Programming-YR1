...
Officer: tchow004
CaseNum: 402-3-74846608-1906165
...
function draw()
{
    ...
    if (det.locationY > 136)
    {
        det.speedX = -1;
        det.speedY = 0;
    }
    if(det.locationX < 386)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if(det.locationY > 196)
    {
        det.speedX = 1;
        det.speedY = 0;
    }
    if(det.locationY > 196 && det.locationX > 700)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    ...
    if(det.locationY > 445 && det.locationX > 571)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if(det.locationY > 567)
    {
        det.speedX = -1;
        det.speedY = 0;
    }
    if(det.locationY > 567 && det.locationX < 265)
    {
        det.speedX = 0;
        det.speedY = 1;
    }
    if(det.locationY > 630)
    {
        det.speedX = 1;
        det.speedY = 0;
    }
    if(det.locationY > 630 && det.locationX >700)
    {
        det.speedX = 0;
        det.speedY = 1;
    }

...
Officer: tchow004
CaseNum: 402-3-98931477-1906165
...
function draw()
{
    ...
    if(det.locationY <511 && det.locationX < 201)
    {
        det.speedX = 0
        det.speedY = -1
    }
    if (det.locationY < 386)
    {
        det.speedX = 1
        det.speedY = 0
    }
    if (det.locationY <386 && det.locationX > 568 )
    {
        det.speedX = 0
        det.speedY = -1
    }
    if (det.locationY <261)
    {
        det.speedX = -1
        det.speedY = 0
    }
    if (det.locationY < 261 && det.locationX < 331)
    {
        det.speedX = 0
        det.speedY = -1
    }
    if (det.locationY < 142)
    {
        det.speedX =1
        det.speedY = 0
    }
    if (det.locationY < 142 && det.locationX > 819)
    {
        det.speedX = 0
        det.speedY = -1
    }
    ...
    if (det.locationY < 79 && det.locationX < 145)
    {
        det.speedX = 0
        det.speedY = -1
    }
